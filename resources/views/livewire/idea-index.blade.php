    ...
    <div class="md:mx-4 flex flex-col justify-between flex-1">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between mt-2 md:mt-6">
        <div class="flex items-center text-xs font-semibold space-x-1 md:space-x-2 text-gray-400">
          <div>
            {{-- <livewire:like-an-idea :idea="$idea" /> --}}
            <abbr title="like">
              <button wire:click.prevent="toggleLike" type="button" class="bg-gray-100 {{ $isLiked ? 'text-v-blue' : 'text-gray-300' }} border px-2 py-1 rounded-xl hover:border-gray-300 transition ease-in duration-150">
