<x-modal 
  foucsElement="idea-title"
  eventToOpenModal="open-edit-idea-modal"
>
    ...
    <form wire:submit.prevent="updateIdea" action="#" method="POST" class="space-y-4 pb-5">
      <div>
        <input wire:model="title" type="text"
          class="idea-title text-sm w-full border border-gray-200 bg-gray-100 rounded-md placeholder:text-gray-900 px-4 py-2 focus:border-blue transition duration-100 ease-in"
