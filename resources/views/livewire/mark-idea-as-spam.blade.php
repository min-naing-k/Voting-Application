<div
  x-data="{ open: false }"
  x-show="open"
  @open-mark-idea-as-spam-modal.window="
    open = true;
    $nextTick(() => { $refs.cancelButton.focus(); });
  "
  @keydown.escape.window="open = false"
  x-init="
    Livewire.on('ideaWasMarkedAsSpam', function() {
      open = false;
    });
  "
  ...
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div
      ...
      <div class="bg-gray-50 px-4 py-3 flex flex-col-reverse sm:px-6 sm:flex-row sm:justify-end">
        <button
          x-ref="cancelButton"
        ...
        <button
          type="button"
          wire:click.prevent="markIdeaAsSpam"
